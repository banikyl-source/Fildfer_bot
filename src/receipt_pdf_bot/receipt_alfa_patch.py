...
def _find_pdf_checker_root() -> Path:
    """Каталог pdf-checker с patch_alfa_amount.py (и font_extend.py)."""
    ...
    raise FileNotFoundError(
        f"Не найден {_PATCH_MODULE}. Задайте PDF_CHECKER_ROOT в .env "
        f"(папка с patch_alfa_amount.py и font_extend.py)."
    )
